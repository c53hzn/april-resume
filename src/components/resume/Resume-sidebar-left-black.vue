<template>
	<section class="layout04" :class="{'hidden': ishidden}">
    <article>
      ...
      <div class="rsm-cmpnt">
        ...
        :key="'language'+language_i" class="font-14">
          {{language.name}}<span v-if="language_i < resume.languages.length - 1">, </span>
        </span>
      </div>
      <div class="rsm-header">
...
.layout04 article:first-child {
  width: 300px;
  color: white;
  background: rgb(54,54,54);
}
.layout04 article:first-child h2 {
  margin: 0px;
}
.layout04 .rsm-header {
  margin: 20px auto 0px auto;
}
.layout04 .rsm-header:first-of-type {
  margin-top: 0px;
}
.layout04 .rsm-header h2 {
  margin: 0px;
}
.layout04 hr {
...
.layout04 article:first-child hr {
  border-color: white;
}
.layout04 .rsm-cmpnt {
  margin: 20px 0px 0px 0px;
}
.layout04 article:first-child .rsm-cmpnt {
  margin: 10px auto;
}
.layout04 .rsm-cmpnt p {
  margin: 0px;
}
.layout04 .rsm-cmpnt-top {
  margin: 0px auto 6px auto;
  display: flex;
}
.layout04 .rsm-cmpnt-top div {
  flex: 1;
}
.layout04 .margin-top-0 {
  margin-top: 0px;
}
.text-left {
  text-align: left;
...
.layout04 .rsm-cmpnt-mid {
  margin: 0px auto 6px auto;
  font-size: 14px;
  font-style: italic;
}
.layout04 .rsm-cmpnt-btm ul {
  margin: 0px auto 6px auto;
  padding-left: 25px;
  list-style: disc;
}
.layout04 .rsm-cmpnt-btm li {
  font-size: 14px;
}
.layout04 article:first-child .rsm-cmpnt {
  margin-bottom: 10px;
